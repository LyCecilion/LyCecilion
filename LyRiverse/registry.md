...
| -------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------ | ------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| **Project Hazelita** | Founded 2024-10-04 by LyCecilion v1.0. The original Hazelita was a CAS computation suite conceived during the KaguReion era as a "beacon" to survive high school — a DSL-driven engine for solving advanced math problems through pure machine logic. Three versions were attempted (Python/SymPy, C#/AngouriMath with atomic decomposition, C# toolkit) before the project was formally laid to rest on 2026-07-11. The community survived the software: Project Hazelita now produces diverse tools and software under the same banner. Community principles: anti-mainstream-narrative, pro-diversity, gender-friendly. See [STORYLINES] §2.3. | Intellectual Core / World Runtime                            | SUBSTRATE    | Hazelita is the runtime that evaluates declarative world specifications (§3.2, CORE-SPEC) — the LyRiverse equivalent of `nix build`. Despite the original CAS project's abandonment, the name persists as the governing entity for all 零音 projects. The dream metamorphosed: what began as a desperate attempt to prove existence became the substrate on which existence is now built. |
